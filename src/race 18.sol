...
contract Bank {
    ...
    function depositTo(address to) public payable nonReentrant {
    ...
    function getBalances(address user) public nonReentrant returns (uint256 balance) {
