...
# Copy pasted readme and some of the natspec to save time

few invariants for this project
1. total supply of dsc should be less than hte total value of collateral
